...
export default class Header extends Component {
     render() {
          return (
               <header id="welcome-section" className="h-screen flex flex-col pl-6 sm:pl-0 sm:items-center sm:text-center bg-gradient-to-b from-coolGray-100 via-coolGray-200 to-coolGray-300">
